...
import skyrl.backends.skyrl_train.weight_sync.lora_nccl.rendezvous as rendezvous_module
...
def test_receiver_constructor_failure_destroys_shared_group(monkeypatch):
    ...
    monkeypatch.setattr(rendezvous_module, "LoRANcclReceiverSession", fail_session)
    consumer_plan = LoRAConsumerPlan(
        LAYOUT_DIGEST,
        type("ReceiverPlan", (), {"modules": ()})(),
        (LoRAConsumerPull(0, LoRASourceSlice("a", (0,), (2,)), (1, 1)),),
